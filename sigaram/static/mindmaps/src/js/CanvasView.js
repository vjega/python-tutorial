...
mindmaps.richmindmaprender = function (map){
    var $drawingArea = $("#drawing-area").children().remove();
    var root = map;
    ...
    if (detach) {
      ...
      $drawingArea.detach();
      self.rich_createNode(root, $drawingArea);
...
function rich_createNode(node, $parent, depth) {
    console.log(node)
