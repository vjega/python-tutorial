...
mindmaps.SaveDocumentView = function() {
  ...
  var $hddSaveButton = $("#button-save-hdd").button().downloadify({
    ...
    swf : '../static/mindmaps/src/media/downloadify.swf',
    downloadImage : '../static/mindmaps/src/img/transparent.png',
    width : 65,
    height : 29,
    append : true
  });
...
richmindmap = mindmapModel;
  //var richmindmap = new mindmaps.MindMapModel(eventBus, commandRegistry, undoController);
