...
router.register(r'stickypositioninfo',      viewsets.StickypositioninfoViewSet)
router.register(r'bulletinboardselectall',  viewsets.BulletinboardselectallInfoViewSet)
