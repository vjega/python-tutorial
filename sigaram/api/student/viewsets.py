...
class TopicInfoViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = studentserializers.TopicsSerializer
    ...
    def list(self, request):
        ...
        if topicid :
            ...
            queryset = models.Topicinfo.objects.all()
            serializer = studentserializers.TopicsSerializer(queryset, many=True)
        return Response(serializer.data)
...
class PostinfoViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = studentserializers.PostinfoSerializer
